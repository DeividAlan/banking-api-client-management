...
from src.controllers.interfaces.individual_client_withdraw_controller import (
...
class IndividualClientWithdrawView(ViewInterface):
    def __init__(self, controller: IndividualClientWithdrawControllerInterface) -> None:
